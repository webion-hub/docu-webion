...
const config: Config = {
  title: "Webion Docs",
  tagline: "Build feature packed UIs with ease",
  favicon: "img/favicon.ico",

  // Set the production url of your site here
  url: "https://docs.webion.it",
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/webion-hub/docu-webion/tree/main",
        },
        blog: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "Instagram",
              href: "https://instagram.com/webion.it",
            },
          ],
        },
        {
